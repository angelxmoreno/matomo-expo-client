...
import { MatomoExpoParams, RecommendedParams, RequiredParams, UserParams, ValidRequestParams } from './types';
import UUID2HexClient from 'uuid2hex-client-js';
import Utility from './Utility';
import { Constants } from 'expo-constants';

export default class MatomoExpo {
    protected idsite: string;
